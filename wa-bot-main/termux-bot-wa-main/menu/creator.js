...
├── _Exemplo: ${prefix}quotemaker random
┠≽ *${prefix}nulis text*
├── _Exemplo: ${prefix}nulis aditya Gans
┠≽ *${prefix}croman TEXTO e amigo*
├── _Exemplo: ${prefix}croman ela e amigo_
┠≽ *${prefix}slide TEXT*
├── _Exemplo: ${prefix}slide aditya & Friend_
┠≽ *${prefix}trigger*
├── _Exemplo: responder imagem e legenda ${prefix}trigger_
┠≽ *${prefix}wasted*
├── _Exemplo: responder imagem e legenda ${prefix}wasted_
┠≽ *${prefix}pelangi*
├── _Exemplo: responder imagem e legenda${prefix}pelangi_
┠≽ *${prefix}sepia*
├── _Exemplo: responder imagem e legenda ${prefix}sepia_
┠≽ *${prefix}merah*
├── _Exemplo: responder imagem e legenda ${prefExemploix}merah_
┠≽ *${prefix}hijau*
├── _Exemplo: responder imagem e legenda ${prefix}hijau_
┠≽ *${prefix}biru*
├── _Exemplo: responder imagem e legenda ${prefix}biru_
┠≽ *${prefix}glass*
├── _Exemplo: responder imagem e legenda ${prefix}glass_
├───────────────────
┠≽ *${prefix}listephoto*
├── Exemplo: para exibir uma lista de fotos_
┠≽ *${prefix}ephoto 1 - 216*
├── Exemplo: ${prefix}ephoto 5 sla_
┠≽ *${prefix}listtextpro*
├── Exemplo: para exibir uma lista de textos profissionais_
┠≽ *${prefix}textpro 1 - 162*
├── Exemplo: ${prefix}textpro 1 aditya_
┠≽ *${prefix}fbgoldbutton TEXT*
├── Exemplo: ${prefix}fbgoldbutton aditya_
┠≽ *${prefix}tahta TEXT*
├── Exemplo: ${prefix}tahta aditya_
┠≽ *${prefix}cglitch TEXT/TEXT*
├── Exemplo: ${prefix}cglitch aditya/Gans_
┠≽ *${prefix}cglass TEXT*
├── Exemplo: ${prefix}cglass aditya_
┠≽ *${prefix}cballon TEXT*
├── Exemplo: ${prefix}cballon aditya_
┠≽ *${prefix}cstyle TEXT*
├── Exemplo: ${prefix}cstyle aditya_
┠≽ *${prefix}clove TEXT*
├── Exemplo: ${prefix}clove aditya_
┠≽ *${prefix}cparty TEXT*
├── Exemplo: ${prefix}cparty aditya_
┠≽ *${prefix}csky TEXT*
├── Exemplo: ${prefix}csky aditya_
┠≽ *${prefix}tts id TEXT*
├── Exemplo: ${prefix}tts id oii seja bem vinda ao bot
┠≽ *${prefix}ttp TEXT*
├── Exemplo: ${prefix}ttp aditya_
├───────────────────
┠≽ *${prefix}stiker*
├── Exemplo: responder imagem e legenda ${prefix}stiker_
┠≽ *${prefix}toimg*
├── Exemplo: responder figurinha com legenda ${prefix}toimg_
┠≽ *${prefix}tovideo*
├── Exemplo: responder vídeo com legenda ${prefix}tovideo_
┠≽ *${prefix}img2url*
├── Exemplo: responder imagem e legenda ${prefix}img2url_
┠≽ *${prefix}tomp3*
├── Exemplo: responder vídeo com legenda ${prefix}tomp3_
┠≽ *${prefix}ocr*
├── Exemplo: responder imagem e legenda ${prefix}ocr_
├───────────────────
┠≽ *${prefix}slow*
├── Exemplo: responder a audio\video com a legenda ${prefix}slow_
┠≽ *${prefix}gemuk*
├── Exemplo: responder a audio\video com a legenda ${prefix}gemuk_
┠≽ *${prefix}tupai*
├── Exemplo: responder a audio\video com a legenda ${prefix}tupai_
┠≽ *${prefix}bass*
├── Exemplo: responder a audio\video com a legenda ${prefix}bass_
┠≽ *${prefix}toptt*
├── Exemplo: responder a audio\video com a legenda ${prefix}toptt_
┬
╰──────────────────────────
`
}
